...
def main():
    ...
    # dataset = load_dataset(args.dataset, cache_dir="/shared/user90/.cache/huggingface/datasets")
    # dataset = load_dataset(args.dataset, split='train[:20%]', cache_dir="/shared/user90/.cache/huggingface/datasets")
    # dataset.save_to_disk('/shared/user90/workspace/datasets/SlimPajama-627B-0.2')
    # exit()
    # dataset = load_from_disk("/shared/user97/workspace/datasets/SlimPajama-627B")
    # dataset = load_from_disk("/shared/user90/workspace/datasets/SlimPajama-627B-0.2")
    ...
    # optimizer = HybridAdam(filter(lambda p: p.requires_grad, model.parameters()),
